...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Des 2023 pada 09.49
...
INSERT INTO `user` (`id_user`, `username`, `password`, `nama_user`, `id_level`, `status`, `role`) VALUES
(1, 'admin', '123', 'Farel Sang Putra', 1, 'aktif', 'admin'),
(6, 'kasir1', '123', 'yudi', 1, 'aktif', 'kasir');
